  ...
  return (
    <>
      ...
      >
        ...
        <main className="max-w-6xl justify-center mx-auto text-center py-2 relative z-10 flex flex-col items-center px-7">
          <header className="mb-8 text-center">
            ...
            <svg
              ...
              viewBox="0 0 256 256"
              className="w-24 h-24 absolute -left-0 lg:left-10  -top-9 transform rotate-39 fill-current ml-10 lg:ml-10 md:ml-12 hidden lg:block md:block "
            >
              <g>
                <path
        ...
        <button
          onClick={toggleTheme}
          className="fixed top-[152px] lg:top-40 right-20 lg:right-20 mr-20 lg:mr-20 p-2 rounded-md  dark:bg-black hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors "
        >
          <div>
            {theme === "dark" ? (
              // <svg
              ...
              // </svg>
              <FlipHorizontalIcon className="h-6 w-6 ml-20 fixed" />
            ) : (
              // <svg
              //   fill="currentColor"
              //   xmlns="http://www.w3.org/2000/svg"
              ...
              //   />
              // </svg>
              <FlipHorizontal2 className="h-6 w-6 ml-20 fixed" />
            )}
          </div>
